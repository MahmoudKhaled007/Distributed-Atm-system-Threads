...
static ServerGui1 ser;
	...
	public static void main(String[] args) throws IOException
	{
            ser=new ServerGui1();
            ser.setVisible(true);
            //ser.jTextArea1.setEnabled(false);
...
//                                        	if (mc.name.equals(oper) && mc.exist==true)
//					{
//                                            money=Integer.parseInt(amount);
//
//                                                double newmoneny=mc.balance+money;
//						mc.dos.writeUTF(this.name+" : "+newmoneny+"success");
//						break;
//					}
                                ...
                                if (oper.equals("eur") && mc.exist==true )
					{
						...
						break;
                                ...
                                // trans#200#client 1#client2   oper#amount#x    
